...
<html lang="en"><!-- indicarle al navegador el idioma del sitio -->
<head><!-- lo incluido en "head" es información que leen los navegadores y los buscadores -->
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0"><!-- permite que el sitio sea adaptable, multidispositivos -->
    ...
    <title>Tags</title><!-- título de la pestaña de la página -->
    ...
    <link rel="stylesheet" type="text/css" media="" href="" href="01-tags.css"><!-- enlazar hoja de estilos css -->
