# :memo: Notes
## BIT
Plan de Estudios para el Bootcamp de Desarrollo Web Full Stack
### OBJETIVOS
Al finalizar el Bootcamp estarás en capacidad de:
* Desarrollar aplicaciones Backend con NodeJS, JavaScript y ExpressJS.
* Crear Páginas y sitios web (frontend) utilizando HTML5 CSS3 JavaScript, y Angular.
* Crear aplicaciones web completas con MEAN Stack. (MongoDB - ExpressJS - Angular - NodeJS).
...
#### Primeros pasos
* ¿Qué es la internet?
* Estructura de archivos del computador (Windows)
* Estructura de archivos del computador Linux
* Manejo terminal de comandos en Windows y principales comandos
* Manejo terminal de comandos en Linux y principales comandos
#### Versionamiento - Primera Parte
* ¿Qué es GIT?
* Importancia de utilizar un sistema de control de versiones
* Instalación de GIT en Windows
* ¿Qué es GitHub?
* Creación de cuenta en GitHub
* Configuraciones iniciales de GIT
* Principales comando de GIT
* Creación de primer repositorio en GitHub y subir primer versión del proyecto
...
* ¿Qué es CSS?
* ¿Qué es JavaScript?
* Instalación de Visual Studio Code - Windows
* Manejo de visual Studio Code
#### Primeros pasos
* Estructura básica de un documento HTML
* Etiquetas semánticas en HTML
* Etiqueta div y su uso
* Títulos en HTML
* Párrafos
* Flujo de una página web
* ¿Cómo implementar CSS en HTML?
...
* Creación del servicio users y conectarlo con la API.
